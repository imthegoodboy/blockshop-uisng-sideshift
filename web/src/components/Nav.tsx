            ...
            <div className="mx-auto max-w-7xl px-6 h-20 flex items-center justify-between gap-8">
                <div className="flex items-center gap-6">
                    ...
                    <nav className="hidden md:flex items-center gap-6">
                        ...
                        <Link href="/how" className="text-sm font-medium hover:text-yellow-600">How It Works</Link>
                        <Link href="/faq" className="text-sm font-medium hover:text-yellow-600">FAQ</Link>
                    </nav>
                </div>
